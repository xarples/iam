 ...
 * @const
 */
proto.user.User.repeatedFields_ = [5];
 ...
 */
proto.user.User.prototype.getProjectList = function() {
  return /** @type{!Array<!proto.project.Project>} */ (
    jspb.Message.getRepeatedWrapperField(this, project_pb.Project, 5));
};
 ...
 * @return {!proto.user.User} returns this
*/
proto.user.User.prototype.setProjectList = function(value) {
 ...
 */
proto.user.User.prototype.addProject = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 5, opt_value, proto.project.Project, opt_index);
};
 ...
 * @return {!proto.user.User} returns this
 */
proto.user.User.prototype.clearProjectList = function() {
